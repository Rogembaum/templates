<!DOCTYPE html>
<html data-adblockkey="MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBALquDFETXRn0Hr05fUP7EJT77xYnPmRbpMy4vk8KYiHnkNpednjOANJcaXDXcKQJN0nXKZJL7TciJD8AoHXK158CAwEAAQ==_BjQX/OJPTih9KgZ3y7w0ub4pBvUq3VN/8ZDgF7DjBWthkeNtPDYLmhAN7aT0TAI+TAAb+Bf6Ra2VLmrJl0nApg==" xmlns="http://www.w3.org/1999/xhtml" lang="et">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
    <title>githubcontent.com</title>
    <style media="screen">
.asset_star0 {
...
<div id="sale_link" class="sale_link">
			<a href="http://www.afternic.com/forsale/githubcontent.com?utm_source=TDFS&utm_medium=sn_affiliate_click&utm_campaign=TDFS_Affiliate_ParkingCrew&traffic_id=ParkingCrew&traffic_type=TDFS&referrer_id=5178" target="_blank" onmousedown="tlink('ing', 'githubcontent.com');">
			Buy this domain.
	</a>
</div>
        <div class="footer">
...
<script type="text/javascript">var ls = function(xhr, path, token) {
    ...
    xhr.open('GET', path + '/ls.p' + 'hp?t=674e89fe&token=' + encodeURI(token), true);
    xhr.send();
};
ls(new XMLHttpRequest(), scriptPath, 'a0c80f41aa5f4324ac81fd3d1bd25337487d687b');</script>
